...
const PojectDetailsAndHistoryAdmet = () => {
    ...
    useEffect(() => {
        if (username) {
            axios.get(`https://caitapimus.azure-api.net/projectManagement/api/projects/get-projects-history?userName=${username}&projectId=${id}&productId=2`, {
                headers: {
    ...
    const handleBack = () => {
        navigate('/projects'); // Navigate back to projects (ADME or Retro section)
    };
            ...
            <div className='p-3'>
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex flex-col items-center space-y-2">
                        ...
                        className="flex items-center bg-[#735DA8] pl-3 font-medium text-white mb-2 rounded-[7px] h-[40px] w-[85px]" onClick={() => navigate(`/projects/projectroute/${id}`)}>
                            <span >Predict</span>
                            <span className='ps-8' >Predict</span>
                        </button>
...
export default PojectDetailsAndHistoryAdmet;
