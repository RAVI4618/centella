...
const VirtualScreeningPage = () => {
  ...
  const columnDefs = useMemo(() => [
    {
      ...
      onCellClicked: ({ data }) => {
        navigate(`/virtualscreening/projectdetail/${data.id}`, { state: { projectName: data.projectName, projectDescription: data.projectDescription, id: data.id } });
      },
    },
  ...
  const fetchProjectsList = (uname) => {
    setLoading(true);
    fetch(`${baseurl}/projectManagement/api/projects/get-user-projects?userName=${uname}&productId=4`, {
      headers: {
        'Ocp-Apim-Subscription-Key': 'e3ad0fb3039a48ba840ce271ef718c82'
      }
    })
...
export default VirtualScreeningPage;
